...
- (void)viewDidLoad {
    ...
    UICollectionView *collection = [[UICollectionView alloc]initWithFrame:rect collectionViewLayout:[[MyLayout alloc]init]];
...
{
    if ([self.collectionView.collectionViewLayout isKindOfClass:[MyLayout class]]) {
